...
const { addUser, findUser, listUsers, updateUser, updateEmail, updatePassword, addToLists, updateListItemCompletionState, updateList, deleteUser } = require("./userController");
...
userRouter.patch("/users/:userId/lists/update/:listId", updateList);
